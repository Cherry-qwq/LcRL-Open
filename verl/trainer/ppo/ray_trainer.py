...
class RayPPOTrainer(object):
    ...
    def _build_grpo_search_languages(self, batch: DataProto) -> tuple[list[str], list[int]]:
        ...
        return question_languages, sampling_strategies
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                # with _timer('step', timing_raw):
                        ...
                        # print(f"  Index values (first 12): {batch.non_tensor_batch['index'][:12]}")
                        # print(f"  Are indices grouped? {batch.non_tensor_batch['index'][0] == batch.non_tensor_batch['index'][1]}")
